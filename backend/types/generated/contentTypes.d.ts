...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Conte\u00FAdo da p\u00E1gina Quem Somos';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    manifestoLead: Schema.Attribute.Text;
    manifestoMuted: Schema.Attribute.Text;
    ...
    titleLead: Schema.Attribute.Text;
    titleMuted: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    servicesLead: Schema.Attribute.Text;
    servicesMuted: Schema.Attribute.Text;
    statementLead: Schema.Attribute.Text;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Case de projeto do portf\u00F3lio';
    displayName: 'Project';
    pluralName: 'projects';
