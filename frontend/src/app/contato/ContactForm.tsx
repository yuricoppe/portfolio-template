    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-9">
      ...
      <div>
        <button
          ...
          className="glow-border glow-border--dark btn-elastic type-display inline-flex h-14 cursor-pointer items-center rounded-[12px] border-0 bg-white px-9 text-[20px] font-medium text-[#0a0a0a] hover:bg-[#d9d9d9] disabled:cursor-default disabled:hover:bg-white"
        >
          {label}
        </button>
        {status === "error" && (
